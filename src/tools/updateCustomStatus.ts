...
export const updateCustomStatusShape = {
  ...
  expiration: z
    ...
    .optional()
    .describe("Status expiration mode. (Do not guess)"),
  expiresAt: z
    .union([z.number(), z.string()])
    .describe(
      "Format relative times as an ISO-8601 string (e.g., '2026-07-28T14:00:00+05:00') using the local offset. Do not calculate epoch milliseconds. (Do not guess)"
    ),
};
